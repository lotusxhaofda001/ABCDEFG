...
[task_local]
#京东直播
10-20/5 12 * * * https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_live.js, tag=京东直播, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
================Loon==============
[Script]
cron "10-20/5 12 * * *" script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_live.js,tag=京东直播
===============Surge=================
京东直播 = type=cron,cronexp="10-20/5 12 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_live.js
============小火箭=========
京东直播 = type=cron,script-path=https://raw.githubusercontent.com/linmudaye/linmudaye/main/jd_live.js, cronexpr="10-20/5 12 * * *", timeout=3600, enable=true
 */
const $ = new Env('京东直播');
