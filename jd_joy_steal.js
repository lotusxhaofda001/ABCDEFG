...
function getFriends(currentPage = '1') {
  return new Promise(resolve => {
    let opt = {
      url: `//draw.jdfcloud.com//common/pet/api/getFriends?itemsPerPage=20&currentPage=${currentPage * 1}&reqSource=weapp${$.getval('jdjoyInvokeKey') || $.invokeKey}`,
...
function getCoinChanges() {
  return new Promise(resolve => {
    let opt = {
      url: `//jdjoy.jd.com/common/pet/getCoinChanges?changeDate=${Date.now()}&reqSource=h5${$.getval('jdjoyInvokeKey') || $.invokeKey}`,
...
function taskUrl(functionId, friendPin) {
  let opt = {
    url: `//jdjoy.jd.com/common/pet/${functionId}?friendPin=${encodeURI(friendPin)}&reqSource=h5${$.getval('jdjoyInvokeKey') || $.invokeKey}`,
    // url: `//draw.jdfcloud.com/common/pet/getPetTaskConfig?reqSource=h5`,
    method: "GET",
    data: {},
    credentials: "include",
